                    ...
                    {data.map((education, index) => (
                        <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                            ...
                            <input 
                                ...
                                className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg outline-none focus:ring-1 focus:ring-blue-500"
                            />
                            ...
                            <div className='grid md:grid-cols-2 gap-3'>
                                ...
                                <input 
                                    ...
                                    type="text" placeholder="GPA / Percentage" 
                                    className="px-3 py-2 text-sm border border-gray-300 rounded-lg outline-none"
                                />
                            </div>
                        </div>
